...
export const POWER_UPS: PowerUpDef[] = [
  { id: 'ember', name: 'Ember Rune', assetKey: 'power-ember', iconPath: 'assets/powerups/v13/ember_rune_material.png', color: 0xff6b2b, description: 'Permanent blast radius +1', activation: 'passive', apply: (s) => ((s.blastRadius += 1), 'Permanent: blast radius +1') },
  { id: 'twin', name: 'Twin Sigil', assetKey: 'power-twin', iconPath: 'assets/powerups/v13/twin_sigil_material.png', color: 0xb86cff, description: 'Permanent bomb capacity +1', activation: 'passive', apply: (s) => ((s.maxBombs += 1), 'Permanent: bomb capacity +1') },
  { id: 'wolfSprint', name: 'Wolf Sprint', assetKey: 'power-wolfSprint', iconPath: 'assets/powerups/v13/wolf_sprint_material.png', color: 0x9ec8ff, description: 'Move 40% faster for 7 seconds', activation: 'auto', apply: (s) => ((s.temporarySpeedBoost = 7000), 'Wolf Sprint active - 7s') },
  { id: 'stoneguard', name: 'Stoneguard Blessing', assetKey: 'power-stoneguard', iconPath: 'assets/powerups/v13/stoneguard_material.png', color: 0xf0ca73, description: 'Heal or absorb one hit for 12 seconds', activation: 'auto', apply: (s) => (s.health < s.maxHealth ? ((s.health += 1), 'Health restored') : ((s.shielded = true), (s.shieldMs = 12000), 'Shield active - 12s')) },
  ...
  { id: 'frostSnare', name: 'Frostsnare', assetKey: 'power-frostSnare', iconPath: 'assets/powerups/v13/frost_snare_material.png', color: 0x75d7ff, description: 'Stored: leave trapping frost for 4.5 seconds', activation: 'stored', apply: () => 'Stored - press Power for Frostsnare' },
  ...
  { id: 'remoteHex', name: 'Remote Hex', assetKey: 'power-remoteHex', iconPath: 'assets/powerups/v13/remote_hex_material.png', color: 0xc050ff, description: 'Arm 3 bombs; HEX detonates the oldest', activation: 'auto', apply: (s) => ((s.hasRemoteDetonator = true), (s.remoteCharges += 3), 'Remote Hex x3 - arm bombs, then press HEX') },
