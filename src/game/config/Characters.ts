...
export const CHARACTERS: CharacterDef[] = [
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/dragon/down.png',
    faction: 'ember',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/wolf/down.png',
    faction: 'moonfang',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/frost/down.png',
    faction: 'frost',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/veil/down.png',
    faction: 'veil',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/skin/down.png',
    faction: 'shadow',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/stone/down.png',
    faction: 'stone',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/raven/down.png',
    faction: 'raven',
  ...
  character({
    ...
    portraitPath: 'assets/champions/runtime/production/beast/down.png',
    faction: 'beast',
